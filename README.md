...
<br>**一、當機器人發送的訊息中，有 "從Slack點餐" 這個按鈕時點擊他，機器人就會私訊你**<br>
![從Slack點餐](./assets/1.PNG)
<br>**二、點擊訊息中 "添加你的午餐"**<br>
![添加你的午餐](./assets/2.PNG)
<br>**三、點擊你欲點的午餐**<br>
![食物列表](./assets/3.PNG)
<br>**四、會彈出視窗，輸入選項 (多選項暫無作用，與前端同步後才會做用)**<br>
![餐點選項](./assets/4.PNG)
<br>**五、點完餐後訊息會發生改變**<br>
![點完餐後](./assets/5.PNG)
<br>**六、一個不夠要多吃兩個訊息會長這樣 (加蛋為裝飾用，沒有效果，不過會顯示)**<br>
![一個不夠要吃兩個](./assets/6.PNG)
<br>**七、點錯了點擊 "清除所有餐點"要清除點單列表，會回歸原樣**<br>
![清除點單](./assets/7.PNG)
<br>**八、送出點餐，這裡點的是招牌飯包**<br>
![送吃點單](./assets/8.PNG)
<br>**九、點完餐後會顯示個人的點單結果**
<br>　　**不點也可以送出點餐，不過你就沒有東西吃囉**<br>
![點單結果](./assets/9.PNG)
